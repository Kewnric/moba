// JunglerOS draft logic. Plain functions with no React or browser code, so mlbb2.html
// and the Node tests in tests/ run exactly the same code.
(function (root, factory) {
  const api = factory();
  if (typeof module === 'object' && module.exports) module.exports = api;
  else root.JunglerEngine = api;
  ...
  function buildHeroList(rawByRole) {
  ...
  function addToFirstEmptySlot(slots, hero) {
  ...
  function placeInSlot(slots, index, hero) {
  ...
  function rankJunglers(junglerNames, enemyNames, matchupData) {
  ...
  function createSafeStorage(getStorage, onError = () => {}) {
